                ...
                <div key={dept.id} className="mt-0.5">
                  ...
                  >
                    <span className="flex items-center text-gray-700">
                      ...
                      <span className="leading-5 line-clamp-5">{dept.name}</span>
                    </span>
                    {hasReports && (
                    ...
                    <div className="ml-6 mt-0.5 space-y-0.5 border-l-2 border-gray-200 pl-3">
                      {dept.reportTypes.map((type) => (
                        <button
                          ...
                          className="w-full text-left px-3 py-1.5 text-sm text-gray-600 hover:text-[#412985] hover:bg-blue-50 rounded transition-colors leading-5 line-clamp-5"
                        >
                          {type.name}
                        </button>
                      ))}
