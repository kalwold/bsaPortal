...
/* ------------------------------------------------------------------ *
 *  Quarterly Report on 2% and above Shareholdings  (A1 = "SHR_GTR_2_TS001")
 *
...
export const extractQuarterlyTwoPercentShareholdersMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
...
const extractQuarterlyTwoPercentShareholdersData = (data) => {
  const { headerRowIdx, dataTableStart } = locateHeader(data);
...
export default extractQuarterlyTwoPercentShareholdersData;
