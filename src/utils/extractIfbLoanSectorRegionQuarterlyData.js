...
export const extractIfbLoanSectorRegionQuarterlyMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
  ...
  if (firstCell.includes('INT_LON_S&R_SR002')) {
        metadata.reportType = 'ifb-quarterly_loan-sector';
        metadata.reportTypeId = 'ifb-quarterly_loan-sector';
...
const extractIfbLoanSectorRegionQuarterlyData = (data) => {
...
export default extractIfbLoanSectorRegionQuarterlyData