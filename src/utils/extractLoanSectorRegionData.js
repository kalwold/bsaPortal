...
export const extractLoanSectorRegionMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
  ...
  if (firstCell.includes('LOAN_SEC & REG') || firstCell.includes('RS001')) {
...
const extractLoanSectorRegionData = (data) => {
...
export default extractLoanSectorRegionData