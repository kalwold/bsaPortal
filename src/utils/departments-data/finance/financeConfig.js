    ...
    periods: [
        ...
        },
        {
            ...
            reportTypes: [
                ...
                { key: "MONTHLY_WEIGHTED_AVG_DEPOSIT_RATES", id: "finance-monthly_weighted-avg-deposit-rates", name: "Monthly Weighted Average Deposit Interest Rates (Conventional Banks)", detect: ["WAADIR001"] },
            ],
        },
        {
            id: "quarterly",
            ...
            reportTypes: [
                ...
                { key: "CAPITAL_ADEQUACY_ONBALANCESHEET", id: "finance-quarterly_onbalance-sheet", name: "CAPITAL ADEQUACY REPORT - On Balance Sheet", detect:  ["CAP_ADQ_ITEM_QI001"]},
                ...
                { key: "QUARTERLY_TOP_TWENTY_DEPOSITORS", id: "finance-quarterly_top20-depositors", name: "Quarterly Top Twenty Depositors", detect:  ["NBE_20_DEP_MR001"]},
                { key: "QUARTERLY_MATURITY_OF_ASSETS_LIABILITIES", id: "finance-quarterly_maturity-asset-liability", name: "Quarterly Maturity of Assets & Liabilities", detect:  ["NBE_MAT_ANL_MA001"]},
                ...
                { key: "QUARTERLY_DEPOSIT_SECTOR_REGION", id: "finance-quarterly_deposit-sector", name: "Quarterly Report on Deposits by Sector and Region", detect:  ["DEP_SEC&REG_DS003"]},
            ],
        },
    ],
}