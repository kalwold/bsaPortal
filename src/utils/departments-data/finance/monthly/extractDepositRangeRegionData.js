...
export const extractDepositRangeRegionMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    const therteenCell = String(row[8] || "").trim();
    ...
    if (firstCell.includes('CDby Range and Reg') || firstCell.includes('CM001')) {
