...
export const extractIfbLoanSectorRegionMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
  ...
  if (firstCell.includes('IFB_LON_S & R') || firstCell.includes('ZZ002')) {
        metadata.reportType = 'ifb-monthly_loan-sector-region';
        metadata.reportTypeId = 'ifb-monthly_loan-sector-region';
...
const extractIfbLoanSectorRegionData = (data) => {
...
export default extractIfbLoanSectorRegionData