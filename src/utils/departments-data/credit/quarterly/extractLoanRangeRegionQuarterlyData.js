...
export const extractLoanRangeRegionQuarterlyMetadata = (data) =>{
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    const sixteenCell = String(row[23] || "").trim();
...
const extractLoanRangeRegionQuarterlyData = (data) =>{
...
export default extractLoanRangeRegionQuarterlyData