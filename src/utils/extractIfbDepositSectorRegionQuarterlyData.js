...
export const extractIfbDepositSectorQuarterlyMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
...
const extractIfbDepositSectorRegionQuarterlyData = (data) => {
...
export default extractIfbDepositSectorRegionQuarterlyData