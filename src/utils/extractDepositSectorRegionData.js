...
export const extractDepositSectorRegionMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    const therteenCell = String(row[10] || "").trim();
    ...
    if (i === 0 && firstCell) {
      ...
      //console.log("Found Return Key:", metadata.ReturnKey);
       ...
       if (firstCell.includes('CDby Sector and RegMD002') || firstCell.includes('MD002')) {
...
const extractDepositSectorRegionData = (data) => {
...
export default extractDepositSectorRegionData