...
export const extractIfbLoanRangeRegionMetadata = (data) => {
  const metadata = {
    reportTitle: "",
    ReturnKey: "",
    institutionCode: "",
...
if (firstCell.includes('IFB_LON_R & R') || firstCell.includes('WW002')) {
        metadata.reportType = 'ifb-monthly_loan-range-region';
        metadata.reportTypeId = 'ifb-monthly_loan-range-region';
