...
export const extractExpenseBreakdownMetadata=(data)=>{
...
const extractExpenseBreakdownData =(data)=>{
...
const topLevelNodes = [];
  ...
  for (let i = dataTableStart; i < data.length; i++) {
    ...
    const isTotalRow = code === '1' ||   code === '1.4' || code ==='2' || code ==='3' || code ==='4';
...
export default extractExpenseBreakdownData